...
import { IncomeEvent } from "@/types/event";
...
export const handleIncomeChange = (
  field: keyof IncomeEvent, 
  value: number, 
  index: number,
...
export const handleIncomeDistributionValueChange = (
  ...
  setScenarioData(prev => {
    ...
    if (event.eventType.type !== "income") return prev;
...
export const handleIncomeDistributionTypeChange = (
